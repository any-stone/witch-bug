...
ALL_OBJECTS	= $(notdir $(C_OBJECTS) $(CPP_OBJECTS) $(CC_OBJECTS))
	...
	#Tell g++ where to find include files for SDL2, SSDL, {fmt}
INCLUDE_FLAGS	= `sdl2-config --cflags` -I/Users/anniekuxa/Documents/cpp_lazy/external/SSDL/include \
				  -I/Users/anniekuxa/Documents/cpp_lazy/external/fmt-master/include
...
LIBRARIES       = ssdl SDL2_image SDL2_ttf SDL2_mixer
LIBRARY_DIRS    = /Users/anniekuxa/Documents/cpp_lazy/external/SSDL/unix
LIB_FLAGS       = -L$(LIBRARY_DIRS) `sdl2-config --libs` \
				  $(foreach library,$(LIBRARIES), -l$(library))

ALL_FLAGS   	= $(INCLUDE_FLAGS) $(LANGUAGE_FLAGS) $(LIB_FLAGS)
...
$(C_OBJECTS): %.o : 	%.c
	g++ -g -c $(INCLUDE_FLAGS) $(LANGUAGE_FLAGS) $< -o $@
